...
import { MicrosoftEdgeClient, type MicrosoftEdgeClientOptions } from '../client.js'
  ...
  if (!apiKey) {
    throw new Error(
      'MACTS_API_KEY environment variable is required. ' +
        'Create an API key with: macts api-key create --name "<name>" --permission microsoft-edge:*:*'
    )
  }
