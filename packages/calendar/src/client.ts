...
export class CalendarClient {
  ...
  constructor(options: CalendarClientOptions) {
    ...
    this.displayalarms = new DisplayAlarmResourceClient(this.#httpClient, 'calendar', 'displayalarms');
    ...
    this.openfilealarms = new OpenFileAlarmResourceClient(this.#httpClient, 'calendar', 'openfilealarms');
  }
