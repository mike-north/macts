 ...
 * List soundalarms.
 */
export class ListSoundAlarmsCommand extends Command {
  static override paths = [["calendar", "calendars", "events", "soundAlarms", "list"]];

  static override usage = Command.Usage({
    description: 'List soundalarms',
  });
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      const items = await client.soundalarms.list();
