 ...
 * List openfilealarms.
 */
export class ListOpenFileAlarmsCommand extends Command {
  static override paths = [['calendar', 'calendars', 'events', 'openFileAlarms', 'list']]

  static override usage = Command.Usage({
    description: 'List openfilealarms',
  })
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      const items = await client.openfilealarms.list()
