...
export class iTermClient {
  ...
  async make(
    ...
    await this.#httpClient.rpc<undefined>('iterm.app.make', {
      new: _new,
      at,
      withData,
      withProperties,
  ...
  async launchAPIScriptNamed(_arguments?: string): Promise<void> {
    await this.#httpClient.rpc<undefined>('iterm.app.launchAPIScriptNamed', {
  ...
  async splitVerticallyWithDefaultProfile(command?: string): Promise<void> {
    await this.#httpClient.rpc<undefined>('iterm.app.splitVerticallyWithDefaultProfile', {
      command,
    })
  }
  ...
  async splitHorizontallyWithDefaultProfile(command?: string): Promise<void> {
    await this.#httpClient.rpc<undefined>('iterm.app.splitHorizontallyWithDefaultProfile', {
      command,
    })
  }
