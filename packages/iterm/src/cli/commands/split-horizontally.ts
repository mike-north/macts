...
export class SplitHorizontallyCommand extends Command {
  ...
  withProfile = Option.String('--with-profile', { required: true, description: "Name of profile for new session." });
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      await client.splitHorizontally(this.withProfile as any, this.command as any);
