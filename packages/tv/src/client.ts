...
export class TVClient {
  ...
  constructor(options: TVClientOptions) {
    ...
    this.libraryplaylists = new LibraryPlaylistResourceClient(this.#httpClient, 'tv', 'libraryplaylists');
    this.playlists = new PlaylistResourceClient(this.#httpClient, 'tv', 'playlists');
    this.playlistwindows = new PlaylistWindowResourceClient(this.#httpClient, 'tv', 'playlistwindows');
