...
import type { InternetLocationFile, InternetLocationFileCreateInput, InternetLocationFileUpdateInput } from '../types.js';
...
export class InternetLocationFileResourceClient {
  ...
  async update(id: string, input: InternetLocationFileUpdateInput): Promise<InternetLocationFile> {
    return this.#http.rpc<InternetLocationFile>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
