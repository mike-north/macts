...
export class RedirectMessageCommand extends Command {
  static override paths = [["mail", "accounts", "mailboxes", "messages", "redirect"]];
  ...
  openingWindow = Option.Boolean('--opening-window', { description: "Whether the window for the redirected message is shown. Default is to not show the window." });
