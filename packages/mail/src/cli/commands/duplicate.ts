...
export class DuplicateCommand extends Command {
  ...
  to = Option.String('--to', { required: false, description: "The location for the new copy or copies." });
  withProperties = Option.String('--with-properties', { required: false, description: "Properties to set in the new copy or copies right away." });
