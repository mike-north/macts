...
export class CreateRuleCommand extends Command {
  ...
  markFlagged = Option.Boolean('--mark-flagged', {
    description: 'If rule matches, mark message as flagged',
  })
  markFlagIndex = Option.String('--mark-flag-index', {
    required: true,
    description:
  ...
  shouldCopyMessage = Option.Boolean('--should-copy-message', {
    description: 'Indicates whether the rule has a copy action',
  })
  shouldMoveMessage = Option.Boolean('--should-move-message', {
    description: 'Indicates whether the rule has a move action',
  })
  stopEvaluatingRules = Option.Boolean('--stop-evaluating-rules', {
