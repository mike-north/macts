...
describe('PropertySchema', () => {
  ...
  it('should reject property with empty code', () => {
    const property = {
      access: 'r',
      description: 'Test property',
      code: '',
  ...
  it('should accept property with code 1-4 characters', () => {
    // 1 character
    let property = {
      access: 'r',
      description: 'Test property',
    ...
    let result = PropertySchema.safeParse(property)
    expect(result.success).toBe(true)
    ...
    result = PropertySchema.safeParse(property)
    expect(result.success).toBe(true)
