...
export class XcodeClient {
  ...
  constructor(options: XcodeClientOptions) {
    ...
    this.sourcedocuments = new SourceDocumentResourceClient(
      this.#httpClient,
      'xcode',
      'sourcedocuments'
    )
    ...
    this.buildconfigurations = new BuildConfigurationResourceClient(
      this.#httpClient,
      'xcode',
      'buildconfigurations'
    )
    this.buildsettings = new BuildSettingResourceClient(this.#httpClient, 'xcode', 'buildsettings')
    this.resolvedbuildsettings = new ResolvedBuildSettingResourceClient(
      this.#httpClient,
      'xcode',
    ...
    this.schemeactionresults = new SchemeActionResultResourceClient(
      this.#httpClient,
      'xcode',
      'schemeactionresults'
    )
    ...
    this.analyzerissues = new AnalyzerIssueResourceClient(
      this.#httpClient,
      'xcode',
      'analyzerissues'
    )
