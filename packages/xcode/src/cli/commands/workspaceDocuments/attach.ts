...
export class AttachWorkspaceDocumentCommand extends Command {
  ...
  toProcessIdentifier = Option.String('--to-process-identifier', { required: true, description: "The process identifier (pid) to which to attach" });
  suspended = Option.Boolean('--suspended', { description: "Whether to start debugging in a suspended state" });
