...
/**
 * List resolvedbuildsettings.
 */
export class ListResolvedBuildSettingsCommand extends Command {
  static override paths = [["xcode", "workspaceDocuments", "projects", "targets", "buildConfigurations", "resolvedBuildSettings", "list"]];

  static override usage = Command.Usage({
    description: 'List resolvedbuildsettings',
  });
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      const items = await client.resolvedbuildsettings.list();
