...
export const microsoftWordApiPlugin = {
  ...
  "permissions": {
    "documents": {
      ...
      "write": [
        "word:documents:save",
        "word:documents:insert",
        "word:documents:update"
      ],
      "delete": [
    ...
    "paragraphs": {
      "read": [
        "word:paragraphs:list",
        "word:paragraphs:get"
      ],
      "write": [
        "word:paragraphs:update"
      ]
    },
    "tables": {
      "read": [
    ...
    "bookmarks": {
      ...
      "create": [
        "word:bookmarks:create"
      ],
      "delete": [
        "word:bookmarks:delete"
      ]
    },
    "fields": {
      "read": [
    ...
    "openQuestions": [
      {
        ...
        "context": "Word's sdef is extremely large (9661 lines) with 170+ classes and 352+ commands",
        "suggestions": [
