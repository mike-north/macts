...
export class CreateDocumentCommand extends Command {
  ...
  trackRevisions = Option.Boolean('--track-revisions', { description: "Whether changes are tracked in the document" });
  showRevisions = Option.Boolean('--show-revisions', { description: "Whether tracked changes are shown" });
  defaultTabStop = Option.String('--default-tab-stop', { required: true, description: "The interval in points between default tab stops" });
