...
export class SaveAsDocumentCommand extends Command {
  ...
  fileName = Option.String('--file-name', { required: true, description: "The file name for the document" });
  fileFormat = Option.String('--file-format', { required: false, description: "The file format for saving", validator: t.isEnum(["document", "documentFormat97", "template", "rtf", "text", "html", "pdf"]) });
