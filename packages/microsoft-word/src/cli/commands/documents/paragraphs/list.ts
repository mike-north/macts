 ...
 * List paragraphs.
 */
export class ListParagraphsCommand extends Command {
  static override paths = [["microsoft-word", "documents", "paragraphs", "list"]];
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      const items = await client.paragraphs.list();
