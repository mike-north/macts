...
export class CreateInstantMessageCommand extends Command {
  ...
  serviceType = Option.String('--service-type', { required: true, description: "The service type of this instant message address." });
  userName = Option.String('--user-name', { required: true, description: "The user name of this instant message address." });
