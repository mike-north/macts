 ...
 */
export class GetYahooHandleCommand extends Command {
  static override paths = [['contacts', 'groups', 'people', 'yahooHandles', 'get']]

  static override usage = Command.Usage({
    description: 'Get a yahoohandle by ID',
  })
  ...
  yahooHandleId = Option.String({ required: true })
