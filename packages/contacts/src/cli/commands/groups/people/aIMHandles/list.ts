 ...
 * List aimhandles.
 */
export class ListAIMHandlesCommand extends Command {
  static override paths = [["contacts", "groups", "people", "aIMHandles", "list"]];

  static override usage = Command.Usage({
    description: 'List aimhandles',
  });
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      const items = await client.aimhandles.list();
