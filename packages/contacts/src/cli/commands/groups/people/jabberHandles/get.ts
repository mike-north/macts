 ...
 */
export class GetJabberHandleCommand extends Command {
  static override paths = [['contacts', 'groups', 'people', 'jabberHandles', 'get']]

  static override usage = Command.Usage({
    description: 'Get a jabberhandle by ID',
  })
  ...
  jabberHandleId = Option.String({ required: true })
