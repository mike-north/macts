...
export class ContactsClient {
  ...
  constructor(options: ContactsClientOptions) {
    ...
    this.instantmessages = new InstantMessageResourceClient(this.#httpClient, 'contacts', 'instantmessages');
    this.jabberhandles = new JabberHandleResourceClient(this.#httpClient, 'contacts', 'jabberhandles');
    ...
    this.socialprofiles = new SocialProfileResourceClient(this.#httpClient, 'contacts', 'socialprofiles');
