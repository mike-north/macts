...
export class ExportCommand extends Command {
  ...
  mediaItems = Option.String('--media-items', { required: true, description: "The list of media items to export" });
  to = Option.String('--to', { required: true, description: "The destination of the export" });
  usingOriginals = Option.Boolean('--using-originals', { description: "Export the original files if true, otherwise export rendered jpgs" });
