...
export class CreateTagCommand extends Command {
  static override paths = [["omnifocus", "tags", "create"]];
  ...
  allowsNextAction = Option.Boolean('--allows-next-action', { description: "If false, tasks associated with this tag will be skipped when determining the next action for a project" });
