...
import type { AutomatorAction, AutomatorActionCreateInput, AutomatorActionUpdateInput } from '../types.js';
...
export class AutomatorActionResourceClient {
  ...
  async update(id: string, input: AutomatorActionUpdateInput): Promise<AutomatorAction> {
    return this.#http.rpc<AutomatorAction>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
