...
import type { SubscriptionPlaylist, SubscriptionPlaylistCreateInput, SubscriptionPlaylistUpdateInput } from '../types.js';
...
export class SubscriptionPlaylistResourceClient {
  ...
  async update(id: string, input: SubscriptionPlaylistUpdateInput): Promise<SubscriptionPlaylist> {
    return this.#http.rpc<SubscriptionPlaylist>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
