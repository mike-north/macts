...
import type { AudioCDPlaylist, AudioCDPlaylistCreateInput, AudioCDPlaylistUpdateInput } from '../types.js';
...
export class AudioCDPlaylistResourceClient {
  ...
  async update(id: string, input: AudioCDPlaylistUpdateInput): Promise<AudioCDPlaylist> {
    return this.#http.rpc<AudioCDPlaylist>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
