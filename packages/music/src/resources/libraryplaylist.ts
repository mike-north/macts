/**
 * LibraryPlaylist client for Music SDK.
...
import type {
  LibraryPlaylist,
  LibraryPlaylistCreateInput,
  LibraryPlaylistUpdateInput,
} from '../types.js'
...
export class LibraryPlaylistResourceClient {
  ...
  async update(id: string, input: LibraryPlaylistUpdateInput): Promise<LibraryPlaylist> {
    return this.#http.rpc<LibraryPlaylist>(`${this.#app}.${this.#resource}.update`, {
      id,
      ...input,
    })
  }
