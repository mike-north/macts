...
export class CreateTrackCommand extends Command {
  static override paths = [["music", "sources", "playlists", "tracks", "create"]];
  ...
  albumArtist = Option.String('--album-artist', { required: true, description: "the album artist of the track" });
  albumDisliked = Option.Boolean('--album-disliked', { description: "is the album for this track disliked?" });
  albumFavorited = Option.Boolean('--album-favorited', { description: "is the album for this track favorited?" });
  albumRating = Option.String('--album-rating', { required: true, description: "the rating of the album for this track (0 to 100)" });
  artist = Option.String('--artist', { required: true, description: "the artist/source of the track" });
  ...
  bpm = Option.String('--bpm', { required: true, description: "the tempo of this track in beats per minute" });
  ...
  compilation = Option.Boolean('--compilation', { description: "is this track from a compilation album?" });
  composer = Option.String('--composer', { required: true, description: "the composer of the track" });
  ...
  disliked = Option.Boolean('--disliked', { description: "is this track disliked?" });
  ...
  eQ = Option.String('--e-q', { required: true, description: "the name of the EQ preset of the track" });
  finish = Option.String('--finish', { required: true, description: "the stop time of the track in seconds" });
  gapless = Option.Boolean('--gapless', { description: "is this track from a gapless album?" });
  genre = Option.String('--genre', { required: true, description: "the music/audio genre (category) of the track" });
  ...
  favorited = Option.Boolean('--favorited', { description: "is this track favorited?" });
  lyrics = Option.String('--lyrics', { required: true, description: "the lyrics of the track" });
  mediaKind = Option.String('--media-kind', { required: true, description: "the media kind of the track" });
  movement = Option.String('--movement', { required: true, description: "the movement name of the track" });
  movementCount = Option.String('--movement-count', { required: true, description: "the total number of movements in the work" });
  movementNumber = Option.String('--movement-number', { required: true, description: "the index of the movement in the work" });
  ...
  shufflable = Option.Boolean('--shufflable', { description: "is this track included when shuffling?" });
  ...
  sortArtist = Option.String('--sort-artist', { required: true, description: "override string to use for the track when sorting by artist" });
  sortAlbumArtist = Option.String('--sort-album-artist', { required: true, description: "override string to use for the track when sorting by album artist" });
  sortName = Option.String('--sort-name', { required: true, description: "override string to use for the track when sorting by name" });
  sortComposer = Option.String('--sort-composer', { required: true, description: "override string to use for the track when sorting by composer" });
  ...
  work = Option.String('--work', { required: true, description: "the work name of the track" });
  ...
  async execute(): Promise<number> {
    ...
    try {
      ...
      const item = await client.tracks.create({
        ...
        albumDisliked: this.albumDisliked,
        albumFavorited: this.albumFavorited,
        ...
        shufflable: this.shufflable,
        skippedCount: this.skippedCount,
        skippedDate: this.skippedDate,
        show: this.show,
        sortAlbum: this.sortAlbum,
        sortArtist: this.sortArtist,
        sortAlbumArtist: this.sortAlbumArtist,
        sortName: this.sortName,
        sortComposer: this.sortComposer,
