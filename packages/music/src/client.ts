...
export class MusicClient {
  ...
  constructor(options: MusicClientOptions) {
    ...
    this.airplaydevices = new AirPlayDeviceResourceClient(this.#httpClient, 'music', 'airplaydevices');
    this.artworks = new ArtworkResourceClient(this.#httpClient, 'music', 'artworks');
    this.audiocdplaylists = new AudioCDPlaylistResourceClient(this.#httpClient, 'music', 'audiocdplaylists');
    this.audiocdtracks = new AudioCDTrackResourceClient(this.#httpClient, 'music', 'audiocdtracks');
    this.browserwindows = new BrowserWindowResourceClient(this.#httpClient, 'music', 'browserwindows');
    ...
    this.libraryplaylists = new LibraryPlaylistResourceClient(this.#httpClient, 'music', 'libraryplaylists');
    this.miniplayerwindows = new MiniplayerWindowResourceClient(this.#httpClient, 'music', 'miniplayerwindows');
    this.playlists = new PlaylistResourceClient(this.#httpClient, 'music', 'playlists');
    this.playlistwindows = new PlaylistWindowResourceClient(this.#httpClient, 'music', 'playlistwindows');
    this.radiotunerplaylists = new RadioTunerPlaylistResourceClient(this.#httpClient, 'music', 'radiotunerplaylists');
    ...
    this.subscriptionplaylists = new SubscriptionPlaylistResourceClient(this.#httpClient, 'music', 'subscriptionplaylists');
