...
export class CreateGroupCommand extends Command {
  ...
  rotation = Option.String('--rotation', { required: true, description: "Rotation of the group in degrees" });
  connectToGroupOnly = Option.Boolean('--connect-to-group-only', { description: "Only connect to the group?" });
