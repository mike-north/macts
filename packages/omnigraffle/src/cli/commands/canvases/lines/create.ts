...
export class CreateLineCommand extends Command {
  ...
  lineType = Option.String('--line-type', {
    required: true,
    description: 'Type of the line',
    validator: t.isEnum(['straight', 'curved', 'orthogonal', 'bezier']),
  })
  hopType = Option.String('--hop-type', {
    required: true,
