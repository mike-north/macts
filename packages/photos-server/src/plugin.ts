...
export const photosApiPlugin = {
  ...
  manifest: {
    ...
    app: {
      ...
      name: 'Photos',
      displayName: 'Photos',
      tccEntitlements: ['photos', 'automation'],
    ...
    suites: [
      ...
      },
      {
        ...
        code: 'IPXS',
        resources: ['MediaItem', 'Container', 'Album', 'Folder', 'Moment'],
        commands: [
          'import',
          'export',
          'duplicate',
    ...
    hierarchy: {
      children: {
        ...
        containers: {
          ...
          access: 'r',
          description:
            'Top level containers in the library, including user created albums and folders',
        },
        mediaItems: {
          resource: 'MediaItem',
          access: 'r',
    ...
    permissions: {
      mediaItems: {
        read: ['photos:mediaItems:list', 'photos:mediaItems:get'],
        create: ['photos:import:files'],
        write: ['photos:mediaItems:update'],
        delete: ['photos:mediaItems:delete'],
      },
      albums: {
        read: ['photos:albums:list', 'photos:albums:get'],
        create: ['photos:containers:create'],
        write: ['photos:albums:update', 'photos:albums:add'],
        delete: ['photos:containers:delete'],
      },
      folders: {
        read: ['photos:folders:list', 'photos:folders:get'],
        create: ['photos:containers:create'],
        write: ['photos:folders:update'],
        delete: ['photos:containers:delete'],
      },
      slideshow: {
        read: [
      ...
      app: {
        read: ['photos:app:spotlight', 'photos:app:search'],
      },
    },
    extraction: {
