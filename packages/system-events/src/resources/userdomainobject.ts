...
import type { UserDomainObject, UserDomainObjectCreateInput, UserDomainObjectUpdateInput } from '../types.js';
...
export class UserDomainObjectResourceClient {
  ...
  async update(id: string, input: UserDomainObjectUpdateInput): Promise<UserDomainObject> {
    return this.#http.rpc<UserDomainObject>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
