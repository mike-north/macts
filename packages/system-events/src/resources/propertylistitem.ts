...
import type { PropertyListItem, PropertyListItemCreateInput, PropertyListItemUpdateInput } from '../types.js';
...
export class PropertyListItemResourceClient {
  ...
  async update(id: string, input: PropertyListItemUpdateInput): Promise<PropertyListItem> {
    return this.#http.rpc<PropertyListItem>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
