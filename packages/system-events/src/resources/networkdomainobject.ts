...
import type { NetworkDomainObject, NetworkDomainObjectCreateInput, NetworkDomainObjectUpdateInput } from '../types.js';
...
export class NetworkDomainObjectResourceClient {
  ...
  async update(id: string, input: NetworkDomainObjectUpdateInput): Promise<NetworkDomainObject> {
    return this.#http.rpc<NetworkDomainObject>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
