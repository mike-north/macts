...
import type {
  ...
  ScriptingDefinitionObjectCreateInput,
  ScriptingDefinitionObjectUpdateInput,
} from '../types.js'
...
export class ScriptingDefinitionObjectResourceClient {
  ...
  async update(
    id: string,
    input: ScriptingDefinitionObjectUpdateInput
  ): Promise<ScriptingDefinitionObject> {
    return this.#http.rpc<ScriptingDefinitionObject>(`${this.#app}.${this.#resource}.update`, {
      id,
      ...input,
    })
  }
