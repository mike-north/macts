...
import type { ClassicDomainObject, ClassicDomainObjectCreateInput, ClassicDomainObjectUpdateInput } from '../types.js';
...
export class ClassicDomainObjectResourceClient {
  ...
  async update(id: string, input: ClassicDomainObjectUpdateInput): Promise<ClassicDomainObject> {
    return this.#http.rpc<ClassicDomainObject>(`${this.#app}.${this.#resource}.update`, { id, ...input });
  }
