...
import type {
  ...
  NetworkPreferencesObjectCreateInput,
  NetworkPreferencesObjectUpdateInput,
} from '../types.js'
...
export class NetworkPreferencesObjectResourceClient {
  ...
  async update(
    id: string,
    input: NetworkPreferencesObjectUpdateInput
  ): Promise<NetworkPreferencesObject> {
    return this.#http.rpc<NetworkPreferencesObject>(`${this.#app}.${this.#resource}.update`, {
      id,
      ...input,
    })
  }
