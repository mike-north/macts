...
export class RemoveActionFromCommand extends Command {
  ...
  usingActionName = Option.String('--using-action-name', { required: false, description: "...or the name of the action to remove" });
  usingActionNumber = Option.String('--using-action-number', { required: false, description: "the index number of the action to remove..." });
