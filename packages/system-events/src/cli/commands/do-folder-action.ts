...
export class DoFolderActionCommand extends Command {
  ...
  folderActionCode = Option.String('--folder-action-code', { required: true, description: "the folder action message to process" });
  withItemList = Option.String('--with-item-list', { required: false, description: "a list of items for the folder action message to process" });
  withWindowSize = Option.String('--with-window-size', { required: false, description: "the new window size for the folder action message to process" });
