...
export class SystemEventsClient {
  ...
  constructor(options: SystemEventsClientOptions) {
    ...
    this.configurations = new ConfigurationResourceClient(
      this.#httpClient,
      'system-events',
      'configurations'
    )
    ...
    this.networkpreferencesobjects = new NetworkPreferencesObjectResourceClient(
      this.#httpClient,
      'system-events',
      'networkpreferencesobjects'
    )
    ...
    this.classicdomainobjects = new ClassicDomainObjectResourceClient(
      this.#httpClient,
      'system-events',
      'classicdomainobjects'
    )
    ...
    this.filepackages = new FilePackageResourceClient(
      this.#httpClient,
      'system-events',
      'filepackages'
    )
    this.folders = new FolderResourceClient(this.#httpClient, 'system-events', 'folders')
    this.localdomainobjects = new LocalDomainObjectResourceClient(
      this.#httpClient,
      'system-events',
      'localdomainobjects'
    )
    this.networkdomainobjects = new NetworkDomainObjectResourceClient(
      this.#httpClient,
      'system-events',
      'networkdomainobjects'
    )
    this.systemdomainobjects = new SystemDomainObjectResourceClient(
      this.#httpClient,
      'system-events',
      'systemdomainobjects'
    )
    this.userdomainobjects = new UserDomainObjectResourceClient(
      this.#httpClient,
      'system-events',
      'userdomainobjects'
    )
    ...
    this.busyindicators = new BusyIndicatorResourceClient(
      this.#httpClient,
      'system-events',
      'busyindicators'
    )
    ...
    this.incrementors = new IncrementorResourceClient(
      this.#httpClient,
      'system-events',
      'incrementors'
    )
    ...
    this.menubaritems = new MenuBarItemResourceClient(
      this.#httpClient,
      'system-events',
      'menubaritems'
    )
    this.menubuttons = new MenuButtonResourceClient(
      this.#httpClient,
      'system-events',
      'menubuttons'
    )
    ...
    this.popupbuttons = new PopUpButtonResourceClient(
      this.#httpClient,
      'system-events',
      'popupbuttons'
    )
    this.processes = new ProcessResourceClient(this.#httpClient, 'system-events', 'processes')
    this.progressindicators = new ProgressIndicatorResourceClient(
      this.#httpClient,
      'system-events',
      'progressindicators'
    )
    this.radiobuttons = new RadioButtonResourceClient(
      this.#httpClient,
      'system-events',
      'radiobuttons'
    )
    this.radiogroups = new RadioGroupResourceClient(
      this.#httpClient,
      'system-events',
      'radiogroups'
    )
    this.relevanceindicators = new RelevanceIndicatorResourceClient(
      this.#httpClient,
      'system-events',
      'relevanceindicators'
    )
    this.rows = new RowResourceClient(this.#httpClient, 'system-events', 'rows')
    this.scrollareas = new ScrollAreaResourceClient(
      this.#httpClient,
      'system-events',
      'scrollareas'
    )
    ...
    this.splittergroups = new SplitterGroupResourceClient(
      this.#httpClient,
      'system-events',
      'splittergroups'
    )
    this.statictexts = new StaticTextResourceClient(
      this.#httpClient,
      'system-events',
      'statictexts'
    )
    ...
    this.valueindicators = new ValueIndicatorResourceClient(
      this.#httpClient,
      'system-events',
      'valueindicators'
    )
    this.propertylistitems = new PropertyListItemResourceClient(
      this.#httpClient,
      'system-events',
      'propertylistitems'
    )
    this.xmlattributes = new XMLAttributeResourceClient(
      this.#httpClient,
      'system-events',
      'xmlattributes'
    )
    this.xmldatas = new XMLDataResourceClient(this.#httpClient, 'system-events', 'xmldatas')
    this.xmlelements = new XMLElementResourceClient(
      this.#httpClient,
      'system-events',
      'xmlelements'
    )
    this.scriptingclasses = new ScriptingClassResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingclasses'
    )
    this.scriptingcommands = new ScriptingCommandResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingcommands'
    )
    this.scriptingdefinitionobjects = new ScriptingDefinitionObjectResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingdefinitionobjects'
    )
    this.scriptingelements = new ScriptingElementResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingelements'
    )
    this.scriptingenumerations = new ScriptingEnumerationResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingenumerations'
    )
    this.scriptingenumerators = new ScriptingEnumeratorResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingenumerators'
    )
    this.scriptingparameters = new ScriptingParameterResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingparameters'
    )
    this.scriptingproperties = new ScriptingPropertyResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingproperties'
    )
    this.scriptingsuites = new ScriptingSuiteResourceClient(
      this.#httpClient,
      'system-events',
      'scriptingsuites'
    )
