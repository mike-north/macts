...
export class CreateTabCommand extends Command {
  static override paths = [["arc", "windows", "tabs", "create"]];
  ...
  location = Option.String('--location', { required: true, description: "Represents the location of the tab in the sidebar. Can be 'topApp', 'pinned', or 'unpinned'." });
