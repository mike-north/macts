...
export class SetConfigurationCommand extends Command {
  ...
  exportable = Option.Boolean('--exportable', { description: "If this environment variable is fine for export, i.e. the Don't Export box is left unchecked (Defaults to Don't Export). This option is ignored for workflow configuration items" });
