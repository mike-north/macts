...
export class CreateDocumentCommand extends Command {
  ...
  detailLevel = Option.String('--detail-level', { required: true, description: "The desired level of detail for the system profile document", validator: t.isEnum(["mini", "basic", "full"]) });
