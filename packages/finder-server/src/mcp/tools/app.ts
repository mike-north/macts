...
export const appOpenTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    await client.open(using as any, withProperties as any);
    return { success: true };
  },
};
...
export const appPrintTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.print(withProperties as any);
    return { success: true };
  },
};
...
export const appDataSizeTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.dataSize(as as any);
    return { success: true };
  },
};
...
export const appDuplicateTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.duplicate(to as any, replacing as any, routingSuppressed as any, exactCopy as any);
    return { success: true };
  },
};
...
export const appMakeTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.make(_new as any, at as any, to as any, withProperties as any);
    return { success: true };
  },
};
...
export const appMoveTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.move(to as any, replacing as any, positionedAt as any, routingSuppressed as any);
    return { success: true };
  },
};
...
export const appCleanUpTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.cleanUp(by as any);
    return { success: true };
  },
};
...
export const appEmptyTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.empty(security as any);
    return { success: true };
  },
};
...
export const appUpdateTool: McpToolDefinition = {
  ...
  handler: async (args) => {
    ...
    const client = getClient();
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    await client.update(necessity as any, registeringApplications as any);
    return { success: true };
  },
};
