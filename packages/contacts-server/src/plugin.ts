...
export const contactsApiPlugin = {
  ...
  manifest: {
    ...
    app: {
      ...
      tccEntitlements: ['automation', 'contacts'],
    ...
    suites: [
      ...
      },
      {
        ...
        commands: ['add', 'remove', 'save'],
        enums: ['SaveableFileFormat', 'InstantMessageServiceType'],
      },
      {
        ...
        code: 'az99',
        resources: [],
        commands: ['actionProperty', 'actionTitle', 'performAction', 'shouldEnableAction'],
        enums: [],
      },
    ],
    resources: {
