  ...
  manifest: {
    ...
    suites: [
      {
        ...
        code: '????',
        resources: ['Account', 'Folder', 'Note', 'Attachment'],
        commands: [],
        enums: [],
      },
    ],
    ...
    commands: {
      list: {
        ...
        scope: 'resource',
        resourceType: ['Account', 'Folder', 'Note', 'Attachment'],
        parameters: [],
      },
      get: {
        name: 'get',
    ...
    permissions: {
      accounts: {
        read: ['notes:accounts:list', 'notes:accounts:get'],
      },
      folders: {
        read: ['notes:folders:list', 'notes:folders:get'],
        create: ['notes:folders:create'],
      },
      notes: {
        read: ['notes:notes:list', 'notes:notes:get'],
        create: ['notes:notes:create'],
        write: ['notes:notes:update'],
      },
    },
  } as AppManifest,
} as const
